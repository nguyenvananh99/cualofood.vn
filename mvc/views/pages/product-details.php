                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="./public/images/products/1.jpg" data-zoom-image="./public/images/products/1.jpg" alt="big-1">
                            </a>
                        </div>
                            ...
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig4.jpg" data-zoom-image="assets/img/product/productbig4.jpg">
                                        <img src="./public/images/products/1.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="./public/images/products/2.jpg" data-zoom-image="assets/img/product/productbig1.jpg">
                                        <img src="./public/images/products/2.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="./public/images/products/3.jpg" data-zoom-image="assets/img/product/productbig2.jpg">
                                        <img src="./public/images/products/3.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="./public/images/products/4.jpg" data-zoom-image="assets/img/product/productbig3.jpg">
                                        <img src="./public/images/products/4.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">
Mì Reeva xương thịt hầm rong biển gói 85g</a></h1>
                            ...
                            <div class="price_box">
                                <span class="current_price">12.000đ</span>
                                <span class="old_price">15.000đ</span>
                                
                            </div>
                            <div class="product_desc">
                                <p>Sợi mì vàng dai ngon hòa quyện vào nước súp Reeva xương thịt hầm rong biển đậm đà thấm đẫm từng sợi  hấp dẫn cùng hương thơm lừng quyến rũ ngất ngây. Mì Reeva xương thịt hầm rong biển gói 85g là lựa chọn tuyệt vời không thể bỏ qua cho những ngày bận rộn cần nạp năng lượng nhanh chóng mà vẫn đủ chất</p>
                            </div>
                            ...
                            <div class=" product_d_action">
                               <ul>
                                   <li><a href="#" title="Add to wishlist">+ Thêm vào mục ưa thích</a></li>
                                   <li><a href="#" title="Add to wishlist">+ Compare</a></li>
                               </ul>
                            </div>
                            <div class="product_meta">
                                <span>Chuyên mục: <a href="#">Đồ ăn nhanh</a></span>
                            </div>
                    ...
                    <div class="product_d_inner">   
                        <div class="product_info_button">    
                            <ul class="nav" role="tablist" id="nav-tab">
                                ...
                                <li>
                                     <a data-toggle="tab" href="#sheet" role="tab" aria-controls="sheet" aria-selected="false">Thuộc tính</a>
                                </li>
                                <li>
                                   <a data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false"> Đánh giá(1)</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                ...
                                Sợi mì vàng dai ngon hòa quyện vào nước súp Reeva xương thịt hầm rong biển đậm đà thấm đẫm từng sợi  hấp dẫn cùng hương thơm lừng quyến rũ ngất ngây. Mì Reeva xương thịt hầm rong biển gói 85g là lựa chọn tuyệt vời không thể bỏ qua cho những ngày bận rộn cần nạp năng lượng nhanh chóng mà vẫn đủ chất
                                </div>    
                            </div>
                                ...
                                <div class="product_d_table">
                                   <form action="#">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="first_child">Loại mì</td>
                                                    <td>Mì nước</td>
                                                </tr>
                                                <tr>
                                                    <td class="first_child">Khối lượng</td>
                                                    <td>85g</td>
                                                </tr>
                                                <tr>
                                                    <td class="first_child">Thành phần</td>
                                                    <td>VẮT MÌ - Bột mì, shortening, tinh bột khoai mì, muối, chất điều vị, chất làm dày, chất ổn định, chất chống oxy hoá, phẩm màu tự nhiên.
GÓI GIA VỊ - Bột thịt và xương, bột chiết xuất cá ngừ, dầu mè, muối, đường, bột ớt, bột tiêu, dầu cọ, bột chiết xuất từ thịt bò, hương thịt tổng hợp,...</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </form>
                                ...
                                <div class="product_info_content">
                                    <p>Mì ngon tuyệt cú mèo, không có điểm nào chê được. 1 sản phẩm chất lượng của Reeva. Reeva, ngon quá đa!!!!!!</p>
                                </div>    
                            </div>
                                ...
                                <div class="reviews_wrapper">
                                    ...
                                    <div class="reviews_comment_box">
                                        ...
                                        <div class="comment_text">
                                            <div class="reviews_meta">
                                                ...
                                                <span>Mì ngon tuyệt cú mèo, không có điểm nào chê được. 1 sản phẩm chất lượng của Reeva. Reeva, ngon quá đa!!!!!!</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product_review_form">
                                        <form action="#">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="review_comment">Đánh giá của bạ<nav></nav> </label>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <p><a href="#">Fruits</a></p>
                                    <div class="price_box"> 
                                        <span class="current_price">10.000đ</sapan>
                                        <span class="old_price">10.000đ0</span>
                                    </div>
                                </figcaption>
                            </figure>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    ...
                                    <a class="secondary_img" hef="product-details.html"><img src="assets/img/product/product16.jpg" alt=""></a>
                                    <div class="label_product"r>
                                        <span class="label_sale">Giảm</span>
                                    </div>
                                    <div class="action_links">
                                        <ul>
