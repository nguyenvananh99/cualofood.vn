<div class="wrapper">
    <nav class="main-header navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <a href="/Admin" class="brand-link navbar-dark">
            <img src="http://localhost/cualofood/admin/public/img/logo34.png" alt="logo.png" class="brand-image logo d-block d-md-none d-sm-block d-sm-none">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav ml-auto pl-2">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?php echo BASE_URL ?>profile?id=<?php echo $_SESSION['adminId'] ?>" class="nav-link">
                        <?php
                ...
                <li class="nav-item">
                <a class="nav-link"  href="<?php echo BASE_URL?>logout?logout=true">
                          Đăng xuất 
                        </a>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="maintenance-menu dropdown-menu dropdown-menu-right" role="menu">
                        <li class="dropdown-item">
                            <form action="/Admin/Common/ClearCache" method="post">
                                <input name="returnurl" type="hidden" value="/Admin/Discount/List">
                                <div class="input-group-append">
                                    <button type="submit" style="width:210px;background-color: Transparent;">
                                        <span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Xóa bộ nhớ cache</font>
                                            </font>
                                        </span>
                                    </button>
                                </div>
                                <input name="__RequestVerificationToken" type="hidden" value="CfDJ8K5ZJ_fvx_lHg-2EHjkH9lTCBNBwSdGKq3C22q7EDKqGDikFLZpe55yrf69AFubDS_jOdy6RQ8Jj-ikFrHg_h3dspiKzbrBmaGc_C2ehrbvjuHK-U8rbCtXZffafEF2HQY3dazPBrjgJHf4gazYO39o">
                            </form>
                        </li>
                    </ul>
                </li>
